...
let AnalyticsService = class AnalyticsService {
    ...
    getAllAnalytic(startTime, endTime) {
        return this.analytics.filter((Analytics) => Analytics.createdAt >= startTime && Analytics.createdAt <= endTime);
    }
...
AnalyticsService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(analytics_schema_1.Analytic.name)),
